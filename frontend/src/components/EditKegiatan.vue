<template>
  <div class="page-wrapper">
    ...
    <div class="container">
      ...
      <form @submit.prevent="simpanKegiatan">
...
function simpanKegiatan() {
  // Ketika klik submit form, munculkan konfirmasi
  showSaveConfirm.value = true
}

function saveActivity() {
  // Simulasi proses penyimpanan
  console.log('Data kegiatan disimpan:', kegiatan.value)

  // Setelah simpan, tutup popup confirm, buka popup sukses

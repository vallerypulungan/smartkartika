<template>
  <div class="chat-page">
    ...
    <div class="chat-header" :style="{ backgroundColor: headerBg }">
      ...
      <h1 class="parent-name">{{ mode === 'parent' ? parentName : teacherName }}</h1>
    </div>
    ...
    <div class="chat-input" :style="{ backgroundColor: inputBg }">
      <input v-model="newMessage" type="text" placeholder="Ketik sesuatu..." @keyup.enter="sendMessage" />
...
// MODE: 'parent' atau 'teacher'
const mode = 'teacher'; // ubah ke 'teacher' kalau mau tampilan sisi guru
